!(function (NioApp, $) {
    ...
    NioApp.CurrentLink = function () {
        ...
        $(_link).each(function () {
            ...
            if (fileName.match(_self_link)) {
                ...
                self.parents('.nk-menu-item')[self.parents('.nk-menu-item').length - 1]?.scrollIntoView({behavior: "smooth", block: "start" });
            } else {
    ...
    NioApp.BS.urlPram = function (elm) {
        ...
        if(modalParam != null){
            const myModal = new bootstrap.Modal(document.getElementById(modalParam))
            myModal.show();
        }
    }
