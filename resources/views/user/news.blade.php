...
$audioPath = $news->media()->wherePivot('type', 'podcast')->first()->path;
    ...
    <style>
        ...
        .vvc-cgallery .vvc-cgs-caption{font-size:18px;line-height:1.55;color:#fff;margin:0;font-family:'asswat-medium';font-weight:400;animation:vvc-cg-fade .35s ease both;}
        .vvc-cgallery .vvc-cgs-source{font-size:16px;line-height:1.55;color:rgba(255,255,255,.92);margin-top:.5rem;font-family:'asswat-medium';}
