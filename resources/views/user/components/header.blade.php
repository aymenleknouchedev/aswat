    ...
    <div class="news-grid-container">
        ...
        <div class="news-feature">
            <a href="{{ route('news.show', $topContents[0]->content->shortlink) }}">
                <img src="{{ $topContents[0]- loading="lazy">content->media()->wherePivot('type', 'main')->first()->path ?? '' }}"
        ...
        <div class="news-list">
            <div class="news-item">
                <a href="{{ route('news.show', $topContents[1]->content->shortlink) }}">
                    <img src="{{ $topContents[1]- loading="lazy">content->media()->wherePivot('type', 'main')->first()->path ?? '' }}"
                        alt="News 1">
                </a>
                <h3>
            ...
            <div class="news-item">
                <a href="{{ route('news.show', $topContents[2]->content->shortlink) }}">
                    <img src="{{ $topContents[2]- loading="lazy">content->media()->wherePivot('type', 'main')->first()->path ?? '' }}"
                        alt="News 2">
                </a>
                <h3>
        ...
        <div class="news-list">
            <div class="news-item">
                <a href="{{ route('news.show', $topContents[4]->content->shortlink) }}">
                    <img src="{{ $topContents[4]- loading="lazy">content->media()->wherePivot('type', 'main')->first()->path ?? '' }}"
                        alt="News 1">
                </a>
                <h3>
            ...
            <div class="news-item">
                <a href="{{ route('news.show', $topContents[5]->content->shortlink) }}">
                    <img src="{{ $topContents[5]- loading="lazy">content->media()->wherePivot('type', 'main')->first()->path ?? '' }}"
                        alt="News 2">
                </a>
                <h3>
