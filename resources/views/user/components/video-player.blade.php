    ...
    @if ($isYouTube && !empty($youtubeId))
        @if ($hasPoster)
            ...
            <div class="video-cover" id="videoCover{{ $uniqueVideoId }}" onclick="loadYouTubeVideo('{{ $uniqueVideoId }}')">
                <img loading="lazy" src="{{ $posterUrl }}" alt="Video thumbnail" style="width: 100%; height: 100%; object-fit: cover; aspect-ratio: 16/9;">
    ...
    @else
        ...
        @if ($hasPoster)
            ...
            <div class="video-cover" id="videoCover{{ $localVideoId }}" onclick="loadLocalVideo('{{ $localVideoId }}')">
                <img loading="lazy" src="{{ $posterImage }}" alt="Video thumbnail" style="width: 100%; height: 100%; object-fit: cover; aspect-ratio: 16/9;">
                <div class="play-button">
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
                        <path d="M12 8L30 20L12 32V8Z" fill="#FFFFFF"/>
                    </svg>
