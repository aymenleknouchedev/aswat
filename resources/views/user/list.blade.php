    ...
    <style>
        ...
        * {
        ...
        header {
            ...
            color: #2c3e50;
            padding: 12px 0;
            position: absolute; /* inside hero, not fixed to viewport */
            width: 100%;
            z-index: 10;
            top: 0;
            left: 0;
        ...
        .scroll-navbar {
            ...
            transform: translateY(-110%); /* hidden slightly above */
            opacity: 0;
            pointer-events: none;
        }
        ...
        nav a:hover {
            ...
            font-weight: 700; /* bold emphasis instead of gradient underline */
        }
        ...
        .scroll-navbar .scroll-menu { position: relative; }
        ...
        .scroll-navbar .menu-toggle:hover { background:#f5f7fa; box-shadow:0 6px 18px rgba(0,0,0,0.06); }
        .scroll-navbar .menu-toggle i { font-size:16px; }
        ...
        .scroll-navbar .dropdown-menu.show { opacity:1; transform:translateY(0); pointer-events:auto; }
        .scroll-navbar .dropdown-menu ul { flex-direction: column; gap: 4px; }
        .scroll-navbar .dropdown-menu ul li { margin:0; }
        ...
        .scroll-navbar .dropdown-menu ul li a:hover { background:#f5f7fa; color:#667eea; }
    .scroll-navbar .dropdown-menu ul li.site-nav-link.active a { background:#eef1ff; color:#667eea; font-weight:700; }
        ...
        .scroll-navbar .dropdown-menu ul li .subnav-list li a:hover { background:#f0f3f7; color:#667eea; }
        .scroll-navbar .dropdown-menu ul li .subnav-list { border-top:1px solid #f1f1f1; margin-top:8px; padding-top:6px; }
        .scroll-navbar .dropdown-menu ul li a.has-sub { display:flex; align-items:center; justify-content:space-between; }
        .scroll-navbar .dropdown-menu ul li a.has-sub.open .sub-arrow { transform:rotate(180deg); }
        /* Active state for inline hero nav */
        header .site-nav-links { gap: 26px; }
        header .site-nav-link a { padding:4px 6px; }
    header .site-nav-link.active a { color:#fff; font-weight:700; }

        /* Hero header subnav dropdown (inline) */
        header .site-nav-link { position: relative; }
        ...
        header .site-nav-link .subnav-list li a:hover { background:#272e37; color:#fff; }
        header .site-nav-link > a.has-sub { display:flex; align-items:center; gap:6px; }
        header .site-nav-link > a.has-sub .sub-arrow { transition: transform .25s ease; font-size:11px; }
        header .site-nav-link > a.has-sub.open .sub-arrow { transform: rotate(180deg); }
        ...
        .film-director {
            ...
            margin-bottom: 18px;
            font-weight: 500;
            font-family: 'asswat-medium', 'asswat-regular', sans-serif;
        }
        ...
        .film-item:nth-child(4) { animation-delay: 0.4s; }
        .film-item:nth-child(5) { animation-delay: 0.5s; }
        .film-item:nth-child(6) { animation-delay: 0.6s; }
        .film-item:nth-child(7) { animation-delay: 0.7s; }
        .film-item:nth-child(8) { animation-delay: 0.8s; }
        .film-item:nth-child(9) { animation-delay: 0.9s; }
        .film-item:nth-child(10) { animation-delay: 1s; }
    </style>
</head>
...
<body>
    ...
    <section class="split-hero">
        <header id="main-header">
            <div class="container">
                <div class="header-content">
                    <a href="/" class="logo">
                        <img class="logo-default" src="{{ asset('user/assets/images/white_logo.svg') }}" alt="Logo" style="height: 40px;">
                        <img class="logo-scrolled" src="{{ asset('user/assets/images/logo.png') }}" alt="Logo" style="height: 40px; display: none;">
                    </a>
                    <nav>
                        <ul class="site-nav-links">
                            <li class="site-nav-link {{ request()->routeIs('latestNews') ? 'active' : '' }}" id="hero-show-subnav">
                                <a href="{{ route('latestNews') }}" class="has-sub" aria-expanded="false">أخبار <i class="fa-solid fa-chevron-down sub-arrow"></i></a>
        ...
        <div class="hero-image">
            <img src="https://www.burgkino.at/sites/default/files/images/2025/one-battle-after-another-15963_19.jpg" alt="هاريس ديكنسون" />
        </div>
                    ...
                    <div class="container">
                        <div class="header-content">
                            ...
                            <div class="scroll-menu">
                                <button class="menu-toggle" aria-expanded="false" aria-label="القائمة">
                                    <i class="fa-solid fa-bars"></i>
                                    <span>القائمة</span>
                                </button>
                                <div class="dropdown-menu" role="menu">
                                    <ul class="site-nav-links">
                                        <li class="site-nav-link {{ request()->routeIs('latestNews') ? 'active' : '' }}" id="site-show-subnav">
                                            <a href="{{ route('latestNews') }}" class="has-sub" aria-expanded="false">أخبار <i class="fa-solid fa-chevron-down sub-arrow" style="font-size:11px;"></i></a>
                                            <ul class="subnav-list" style="list-style:none; margin:6px 0 0; padding:0; display:none;">
                                                <li class="site-subnav-link"><a href="{{ route('newSection', ['section' => 'algeria']) }}">الجزائر</a></li>
                                                <li class="site-subnav-link"><a href="{{ route('newSection', ['section' => 'world']) }}">عالم</a></li>
                                                <li class="site-subnav-link"><a href="{{ route('newSection', ['section' => 'economy']) }}">اقتصاد</a></li>
                                                <li class="site-subnav-link"><a href="{{ route('newSection', ['section' => 'sports']) }}">رياضة</a></li>
            ...
            <div class="film-list">
                ...
                <div class="film-item">
                    ...
                    <div class="film-poster">
                        <img src="https://via.placeholder.com/200x300/667eea/FFFFFF?text=الختم+السابع"
                            alt="ملصق الفيلم">
                    </div>
                    <div class="film-details">
                        <h2 class="film-title">الختم السابع</h2>
                        <p class="film-director">إخراج إنغمار برغمان</p>
                        ...
                        <div class="film-metadata">
                            <div class="film-meta-item"><span class="rating">★★★★★</span> 5/5</div>
                            <div class="film-meta-item">السنة: 1957</div>
                            <div class="film-meta-item">المدة: 96 دقيقة</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="film-item">
                    <div class="film-number"></div>
                    <div class="film-poster">
                        <img src="https://via.placeholder.com/200x300/667eea/FFFFFF?text=باريس+تكساس"
                            alt="ملصق الفيلم">
                    </div>
                    <div class="film-details">
                        <h2 class="film-title">باريس، تكساس</h2>
                        <p class="film-director">إخراج فيم فيندرز</p>
                        ...
                        <div class="film-metadata">
                            <div class="film-meta-item"><span class="rating">★★★★★</span> 5/5</div>
                            <div class="film-meta-item">السنة: 1984</div>
                            <div class="film-meta-item">المدة: 145 دقيقة</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="film-item">
                    <div class="film-number"></div>
                    <div class="film-poster">
                        <img src="https://via.placeholder.com/200x300/667eea/FFFFFF?text=امرأة+تحت+التأثير"
                            alt="ملصق الفيلم">
                    </div>
                    <div class="film-details">
                        <h2 class="film-title">امرأة تحت التأثير</h2>
                        <p class="film-director">إخراج جون كاسافيتيس</p>
                        ...
                        <div class="film-metadata">
                            <div class="film-meta-item"><span class="rating">★★★★★</span> 5/5</div>
                            <div class="film-meta-item">السنة: 1974</div>
                            <div class="film-meta-item">المدة: 155 دقيقة</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="film-item">
                    <div class="film-number"></div>
                    <div class="film-poster">
                        <img src="https://via.placeholder.com/200x300/667eea/FFFFFF?text=باري+ليندون" alt="ملصق الفيلم">
                    </div>
                    <div class="film-details">
                        <h2 class="film-title">باري ليندون</h2>
                        <p class="film-director">إخراج ستانلي كوبريك</p>
                        ...
                        <div class="film-metadata">
                            <div class="film-meta-item"><span class="rating">★★★★★</span> 5/5</div>
                            <div class="film-meta-item">السنة: 1975</div>
                            <div class="film-meta-item">المدة: 187 دقيقة</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="film-item">
                    <div class="film-number"></div>
                    <div class="film-poster">
                        <img src="https://via.placeholder.com/200x300/667eea/FFFFFF?text=الـ400+ضربة" alt="ملصق الفيلم">
                    </div>
                    <div class="film-details">
                        <h2 class="film-title">الـ400 ضربة</h2>
                        <p class="film-director">إخراج فرانسوا تروفو</p>
                        ...
                        <div class="film-metadata">
                            <div class="film-meta-item"><span class="rating">★★★★★</span> 5/5</div>
                            <div class="film-meta-item">السنة: 1959</div>
                            <div class="film-meta-item">المدة: 99 دقيقة</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="film-item">
                    <div class="film-number"></div>
                    <div class="film-poster">
                        <img src="https://via.placeholder.com/200x300/667eea/FFFFFF?text=افعل+الصواب" alt="ملصق الفيلم">
                    </div>
                    <div class="film-details">
                        <h2 class="film-title">افعل الصواب</h2>
                        <p class="film-director">إخراج سبايك لي</p>
                        ...
                        <div class="film-metadata">
                            <div class="film-meta-item"><span class="rating">★★★★★</span> 5/5</div>
                            <div class="film-meta-item">السنة: 1989</div>
                            <div class="film-meta-item">المدة: 120 دقيقة</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="film-item">
                    <div class="film-number"></div>
                    <div class="film-poster">
                        <img src="https://via.placeholder.com/200x300/667eea/FFFFFF?text=بيرسونا" alt="ملصق الفيلم">
                    </div>
                    <div class="film-details">
                        ...
                        <div class="film-metadata">
                            <div class="film-meta-item"><span class="rating">★★★★★</span> 5/5</div>
                            <div class="film-meta-item">السنة: 1966</div>
                            <div class="film-meta-item">المدة: 83 دقيقة</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="film-item">
                    <div class="film-number"></div>
                    <div class="film-poster">
                        <img src="https://via.placeholder.com/200x300/667eea/FFFFFF?text=آخر+عرض+سينمائي"
                            alt="ملصق الفيلم">
                    </div>
                    <div class="film-details">
                        <h2 class="film-title">آخر عرض سينمائي</h2>
                        <p class="film-director">إخراج بيتر بوجدانوفيتش</p>
                        ...
                        <div class="film-metadata">
                            <div class="film-meta-item"><span class="rating">★★★★★</span> 5/5</div>
                            <div class="film-meta-item">السنة: 1971</div>
                            <div class="film-meta-item">المدة: 126 دقيقة</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="film-item">
                    <div class="film-number"></div>
                    <div class="film-poster">
                        <img src="https://via.placeholder.com/200x300/667eea/FFFFFF?text=الحذاء+الأحمر"
                            alt="ملصق الفيلم">
                    </div>
                    <div class="film-details">
                        <h2 class="film-title">الحذاء الأحمر</h2>
                        <p class="film-director">إخراج مايكل باول وإيميريك Pressburger</p>
                        ...
                        <div class="film-metadata">
                            <div class="film-meta-item"><span class="rating">★★★★★</span> 5/5</div>
                            <div class="film-meta-item">السنة: 1948</div>
                            <div class="film-meta-item">المدة: 133 دقيقة</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="film-item">
                    <div class="film-number"></div>
                    <div class="film-poster">
                        <img src="https://via.placeholder.com/200x300/667eea/FFFFFF?text=معركة+الجزائر"
                            alt="ملصق الفيلم">
                    </div>
                    <div class="film-details">
                        <h2 class="film-title">معركة الجزائر</h2>
                        <p class="film-director">إخراج جيلو بونتيكورفو</p>
                        ...
                        <div class="film-metadata">
                            <div class="film-meta-item"><span class="rating">★★★★★</span> 5/5</div>
                            <div class="film-meta-item">السنة: 1966</div>
                            <div class="film-meta-item">المدة: 121 دقيقة</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer>
        <div class="container">
            ...
            <div class="copyright">
                © 2023 مجموعة كريتيريون. جميع الحقوق محفوظة.
            </div>
        </div>
    </footer>
