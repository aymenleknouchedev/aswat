                    ...
                    <div class="container">
                        ...
                        <form action="{{ route('dashboard.writer.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <textarea name="bio" class="form-control" id="bio" rows="4" maxlength="200">{{ old('bio', isset($writer) ? $writer->bio : '') }}</textarea>
                                    <small class="text-muted">
                                        <span
                                            id="bio-count">{{ strlen(old('bio', isset($writer) ? $writer->bio : '')) }}</span>
                                        / 200
                                    </small>
                                </div>
                                @error('bio')
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary" data-en="Add Writer"
                                    data-ar="إضافة كاتب">
                                    <i class="fa fa-plus"></i> إضافة كاتب
                                </button>
                            </div>
                        </form>
