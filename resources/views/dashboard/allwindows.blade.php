                        ...
                        <div class="nk-block nk-block-lg">
                            ...
                            <div class="card card-bordered card-preview">
                                <div class="card-inner">
                                    <form method="GET" action="{{ route('dashboard.windows.index') }}" class="row g-2 align-items-center">
                                        ...
                                        <div class="col-md-2 col-6">
                                            <a href="{{ route('dashboard.windows.index') }}" class="btn btn-light w-100 center"
                                ...
                                <table class="table table-orders">
                                    ...
                                    <tbody class="tb-odr-body">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="2" class="text-center" data-en="No windows found"
                                                    data-ar="لا توجد نوافذ">
                                                    لا توجد نوافذ
                                                </td>
                                            </tr>
                                        @endforelse
