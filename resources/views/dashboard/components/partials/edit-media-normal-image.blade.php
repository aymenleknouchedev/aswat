    ...
    <div class="row g-3">
        ...
        <div class="col-md-4">
            ...
            <div class="media-preview border rounded mb-2" id="preview-normal_main_image"
                ...
                @if (!empty($mainImagePaths[0]) && $content->template === 'normal_image')
        ...
        <div class="col-md-4">
            ...
            <div class="media-preview border rounded mb-2" id="preview-normal_mobile_image"
                style="aspect-ratio: 16/9;">
                @if (!empty($mobileImagePaths[0]) && $content->template === 'normal_image')
        ...
        <div class="col-md-4">
            ...
            <div class="media-preview border rounded mb-2" id="preview-normal_content_image"
                style="aspect-ratio: 16/9;">
                @if (!empty($contentImagePaths[0]) && $content->template === 'normal_image')
