...
<style>
    ...
    .mmxx-tab-btn:focus {
        outline: 2px solid var(--vvc-primary);
        outline-offset: 1px;
    }
    ...
    .mmxx-btn-select:not(:disabled):hover {
        background: var(--bs-success-bg-subtle);
        border-color: var(--bs-success-border-subtle);
        color: var(--bs-success-text-emphasis);
    }

    .mmxx-btn-select:disabled {
        background: var(--bs-gray-400);
        border-color: var(--bs-gray-400);
        color: var(--bs-white);
        opacity: 0.6;
    ...
    @media (max-width: 768px) {
        ...
        .mmxx-tabs { flex-wrap: wrap; }
        .mmxx-filters { flex-direction: column; padding: .75rem !important; }
        .mmxx-filters input,
        .mmxx-filters select,
        .mmxx-uploader {
        ...
        .mmxx-uploader { flex-direction: column; align-items: stretch; }
        .mmxx-uploader-actions { width: 100%; }
        .mmxx-uploader-actions .mmxx-btn { width: 100%; }
    }
</style>
...
<script>
    (() => {
        ...
        // Visual feedback and auto-fill for URL input
        uploadUrlInput?.addEventListener('input', (e) => {
            const url = e.target.value.trim();
            if (url && !urlNameInput.value) {
                try {
                    ...
                    if (nameWithoutExt && nameWithoutExt !== '') {
                        ...
                        urlAltInput.value = nameWithoutExt;
                    }
                } catch (err) {
                    // Invalid URL, ignore
                }
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" data-ar="إضافة / تعديل عنصر" data-en="Add / Edit Item">إضافة / تعديل عنصر
                </h5>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="mb-2">
                            <label class="form-label" data-ar="الرابط" data-en="Link">
                                الرابط <small class="text-muted" id="itemLinkNote" data-ar="(مطلوب في وضع ملف)"
                                    data-en="(Required in File mode)">
                                    (مطلوب في وضع ملف)
                                </small>
                            </label>
                            <input id="itemLinkUrl" class="form-control" data-ar="https://..."
                                data-en="https://..." />
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group mb-2">
                                <input id="itemMediaUrl" class="form-control" data-ar="لم يتم الاختيار"
                                    data-en="Not selected" readonly />
                                <button type="button" class="btn btn-outline-secondary" id="btnPickMedia"
                                    data-ar="اختيار الوسائط" data-en="Pick media">
                        ...
                        <div class="mb-2">
                            ...
                            <textarea id="itemDescription" class="form-control tinymce-simple" rows="4" data-ar="الوصف"
                                data-en="Description"></textarea>
                        </div>
                        ...
                        <script>
                            ...
                            // This gives us identical plugins, toolbar, custom vvc* buttons and
                            // file picker. We avoid loading a second TinyMCE bundle (which would
                            // clash with the global one).
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                tinymce.init({
                                    ...
                                    paste_preprocess: (plugin, args) => {
                                        args.content = args.content.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, '');
                                    },
                                    setup: (editor) => {
                                        editor.on('init', () => {
                                        ...
                                        // Register the same custom buttons as the main editor
            ...
            <div class="modal-footer modal-footer-sticky">
                ...
                <button id="saveItemBtn" type="button" class="btn btn-success mx-2" data-ar="حفظ العنصر"
                    data-en="Save Item">
