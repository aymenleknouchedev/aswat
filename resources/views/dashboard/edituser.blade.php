                                ...
                                <form action="{{ route('dashboard.user.update', $user->id) }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-2">
                                            <input id="userImageUrl" class="form-control" data-ar="لم يتم الاختيار"
                                                data-en="Not selected" readonly value="{{ old('image', $user->image) }}" />
    ...
    <div id="userMediaModal" class="mmxx-modal" aria-hidden="true" role="dialog" aria-modal="true"
        ...
        <div class="mmxx-container" role="document">
            <div class="mmxx-header">
                <h5 id="userMediaModalTitle" data-ar="اختر صورة المستخدم" data-en="Select User Image">اختر صورة المستخدم
                </h5>
