                    ...
                    <div class="container">
                        ...
                        <form action="{{ route('dashboard.writer.update', $writer->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="text" name="slug" class="form-control" id="slug"
                                        value="{{ old('slug', $writer->slug) }}" placeholder="مثال: ahmed-mohamed" required>
                                </div>
                                @error('slug')
                                    <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <textarea name="bio" class="form-control" id="bio" rows="4" maxlength="210" required>{{ old('bio', $writer->bio) }}</textarea>
