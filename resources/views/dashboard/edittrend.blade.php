                        ...
                        <form action="{{ route('dashboard.trend.update', $trend->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-2">
                                    <input id="socialImageUrl" class="form-control" data-ar="لم يتم الاختيار"
                                        ...
                                        value="{{ old('social_image', $trend->social_image) }}" />
                                ...
                                <input type="hidden" id="social_image" name="social_image"
                                    value="{{ old('social_image', $trend->social_image) }}">
                                <div id="socialImagePreview" class="mt-2">
                                    @if ($trend->social_image)
                                        <img src="{{ $trend->social_image }}" alt="صورة السوشيال ميديا"
                                            class="media-preview">
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" rows="3" class="form-control"
                                    placeholder="الوصف (يُستخدم في عنوان التبويب ومشاركة السوشيال ميديا)">{{ old('description', $trend->description) }}</textarea>
                            </div>
