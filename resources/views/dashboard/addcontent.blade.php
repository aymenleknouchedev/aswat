                                    ...
                                    <div class="social-media-tab-content">
                                        <div class="row g-3 mt-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card h-100">
                                                    <div class="card-header">
                                                        <h6 class="card-title mb-0" data-ar="صورة المحتوى"
                                                            data-en="Content Image">
                                                            صورة المحتوى
                                                        </h6>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="mb-3">
                                                            <label for="share_image" class="form-label small text-muted">
                                                                اختر صورة للمشاركة على وسائل التواصل الاجتماعي
                                                            </label>
                                                            <input type="file" id="share_image" name="share_image"
                                                                class="form-control" accept="image/*"
                                                                onchange="previewShareImage(this)">
                                                        </div>
                                                        <div
                                                            class="image-preview-container border rounded p-3 text-center bg-light">
                                                            <div id="share_image_preview_wrapper" class="d-none">
                                                                <div class="image-preview-wrapper">
                                                                    <img id="share_image_preview" src=""
                                                                        alt="صورة المشاركة"
                                            ...
                                            <div class="col-md-6">
                                                <div class="card h-100">
                                                    <div class="card-header">
                                                        <h6 class="card-title mb-0" data-ar="محتوى المشاركة"
                                                            data-en="Share Content">
                                                            محتوى المشاركة
                                                        </h6>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="mb-3">
                                                            <label for="share_title" class="form-label"
                                                                data-ar="عنوان المشاركة" data-en="Share Title">عنوان
                                                                المشاركة</label>
                                                            ...
                                                            <div class="form-text">سيظهر هذا العنوان عند مشاركة المحتوى على
                                                                وسائل التواصل الاجتماعي</div>
                                                        </div>

                                                        <div class="mb-0">
                                                            <label for="share_description" class="form-label"
                                                                data-ar="وصف المشاركة" data-en="Share Description">وصف
                                                                المشاركة</label>
                                                            <textarea id="share_description" name="share_description" class="form-control" rows="4"
                                                                placeholder="أدخل وصف المشاركة" oninput="updatePreview()">{{ old('share_description', '') }}</textarea>
                                                            <div class="form-text">سيظهر هذا الوصف عند مشاركة المحتوى على
                                                                وسائل التواصل الاجتماعي</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h6 class="card-title mb-0" data-ar="معاينة المشاركة"
                                                            data-en="Share Preview">
                                                            معاينة المشاركة
                                                        </h6>
                                                    </div>
                                                    <div class="card-body">
                                                                ...
                                                                <div class="social-preview bg-white border rounded p-3">
                                                                    <div class="d-flex align-items-start mb-2">
                                                                        ...
                                                                        <div class="flex-grow-1 ms-2">
                                                                            <div class="fw-bold" id="preview_site_name">
                                                                                أصوات جزائرية</div>
                                                                            <div class="text-muted small">الآن</div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="preview-content mt-2">
                                                                        <p class="mb-1" id="preview_title">
                                                                            {{ old('share_title', '') ?: 'عنوان المشاركة' }}
                                                                        </p>
                                                                        <p class="small text-muted mb-2"
                                                                            id="preview_description">
                                                                            {{ old('share_description', '') ?: 'وصف المشاركة' }}
                                                                        </p>
                                                                        ...
                                                                        <div class="text-muted small" id="preview_url">
                                                                            www.algerie-voices.dz</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
