                    ...
                    <div class="container">
                        ...
                        <form action="{{ route('dashboard.trend.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div id="trendImagePreview" class="mt-2"></div>
                                @error('image')
                                    <span class="text-danger small">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" class="btn btn-primary" data-en="Add Trend" data-ar="إضافة ترند">
                                    <i class="fa fa-plus"></i> إضافة ترند
                                </button>
                            </div>
                        </form>
    ...
    <div id="trendMediaModal" class="mmxx-modal" aria-hidden="true" role="dialog" aria-modal="true"
        ...
        <div class="mmxx-container" role="document">
            <div class="mmxx-header">
                <h5 id="trendMediaModalTitle" data-ar="اختر صورة الترند" data-en="Select Trend Image">اختر صورة الترند</h5>
