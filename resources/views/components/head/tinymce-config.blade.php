...
<script>
    ...
    tinymce.init({
        ...
        .read-more-block .read-more-label-text{position:absolute;top:0.75rem;right:0.75rem;font-size:0.8rem;font-weight:600;color:#666;background:#e7e7e7;padding:0.25rem 0.75rem;border-radius:4px;z-index:2;}
